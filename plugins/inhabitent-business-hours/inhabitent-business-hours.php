 ...
 *
 * The Inhabitent Business Hours is an organized, maintainable boilerplate for building widgets using WordPress best practices.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Widget_Name
 * @author    Jennifer Yiu <jen.yiu.90@gmail.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        Inhabitent Business Hours
 * Description:       Widget for Inhabitent Project Business Hours 
 * Version:           1.0.0
 * Author:            Jennifer Yiu
 * Author URI:        @TODO
 * License:           GPL-2.0+
